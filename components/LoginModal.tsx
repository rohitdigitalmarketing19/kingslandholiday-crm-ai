  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-xl flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl border border-slate-200/60 overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        {/* Header Branding */}
        <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white px-8 pt-8 pb-7 text-center relative overflow-hidden">
          ...
          <div className="w-11 h-11 bg-white/10 backdrop-blur-md rounded-xl flex items-center justify-center text-lg mx-auto mb-3.5 border border-white/10 shadow-lg">
          ...
          <p className="text-xs text-slate-400 font-medium mt-1">
            {mode === 'login' ? 'Secure Portal Access' : 'Admin OTP Password Recovery'}
          </p>
        </div>
        ...
        {mode === 'login' && (
          <div>
            <div className="px-8 pt-5 pb-1">
              <h3 className="text-sm font-semibold text-slate-800">Login</h3>
              <p className="text-xs text-slate-400 mt-0.5">Enter your credentials to access the workspace.</p>
            </div>

            <form onSubmit={handleLoginSubmit} className="px-8 pb-7 pt-3 space-y-3.5">
              {successMsg && (
